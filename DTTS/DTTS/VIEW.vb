...
Public Class VIEW
    ...
    Private Sub btnExport2_Click(sender As Object, e As EventArgs) Handles btnExport2.Click
        ...
        ds = New DataSet
        tables = ds.Tables
        objAdap = New OleDbDataAdapter("SELECT Date_Recorded AS [Date], Time_In AS [Time In], Time_Out AS [Time Out] FROM Records WHERE User_Name= '" & DTR.lnkViewUserRecords.Text.ToString.ToUpper & "'", MyConn) 'Change items to your database name
